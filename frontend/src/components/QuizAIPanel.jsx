      ...
      <div className="p-3 border-t border-gray-100 shrink-0">
        ...
        <div className="flex gap-2">
          ...
          <input
            ...
            placeholder={uploadedFile ? "What questions should I generate?" : "Generate 5 JavaScript questions..."}
            value={input}
